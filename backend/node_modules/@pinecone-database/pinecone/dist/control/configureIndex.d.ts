import { ManageIndexesApi, IndexModel, ConfigureIndexRequest } from '@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control';
import type { IndexName } from '@pinecone-database/pinecone/dist/control/types';
