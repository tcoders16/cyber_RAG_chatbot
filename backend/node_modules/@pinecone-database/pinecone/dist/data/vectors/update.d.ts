import { VectorOperationsProvider } from '@pinecone-database/pinecone/dist/data/vectors/vectorOperationsProvider';
import type { RecordId, RecordValues, RecordSparseValues, RecordMetadata } from '@pinecone-database/pinecone/dist/data/vectors/types';
/**
