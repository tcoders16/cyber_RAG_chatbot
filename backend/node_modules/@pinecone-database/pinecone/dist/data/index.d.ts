import type { FetchOptions } from '@pinecone-database/pinecone/dist/data/vectors/fetch';
import type { UpdateOptions } from '@pinecone-database/pinecone/dist/data/vectors/update';
import type { QueryOptions } from '@pinecone-database/pinecone/dist/data/vectors/query';
import type { DeleteOneOptions } from '@pinecone-database/pinecone/dist/data/vectors/deleteOne';
import { deleteOne } from '@pinecone-database/pinecone/dist/data/vectors/deleteOne';
import type { DeleteManyOptions } from '@pinecone-database/pinecone/dist/data/vectors/deleteMany';
import { deleteMany } from '@pinecone-database/pinecone/dist/data/vectors/deleteMany';
import { describeIndexStats } from '@pinecone-database/pinecone/dist/data/vectors/describeIndexStats';
import type { ListOptions } from '@pinecone-database/pinecone/dist/data/vectors/list';
import { listPaginated } from '@pinecone-database/pinecone/dist/data/vectors/list';
import { SearchRecordsOptions } from '@pinecone-database/pinecone/dist/data/vectors/searchRecords';
import { HTTPHeaders } from '@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_data';
import type { PineconeConfiguration, PineconeRecord, RecordMetadata, IntegratedRecord } from '@pinecone-database/pinecone/dist/data/vectors/types';
export type { PineconeConfiguration, PineconeRecord, RecordId, RecordSparseValues, RecordValues, RecordMetadata, RecordMetadataValue, IntegratedRecord, } from '@pinecone-database/pinecone/dist/data/vectors/types';
export type { DeleteManyOptions, DeleteManyByFilterOptions, DeleteManyByRecordIdOptions, } from '@pinecone-database/pinecone/dist/data/vectors/deleteMany';
export type { DeleteOneOptions } from '@pinecone-database/pinecone/dist/data/vectors/deleteOne';
export type { DescribeIndexStatsOptions, IndexStatsDescription, IndexStatsNamespaceSummary, } from '@pinecone-database/pinecone/dist/data/vectors/describeIndexStats';
export type { FetchOptions, FetchResponse } from '@pinecone-database/pinecone/dist/data/vectors/fetch';
export type { UpdateOptions } from '@pinecone-database/pinecone/dist/data/vectors/update';
export type { ScoredPineconeRecord, QueryByRecordId, QueryByVectorValues, QueryOptions, QueryResponse, QueryShared, } from '@pinecone-database/pinecone/dist/data/vectors/query';
export type { ListOptions } from '@pinecone-database/pinecone/dist/data/vectors/list';
export type { SearchRecordsOptions, SearchRecordsQuery, SearchRecordsRerank, SearchRecordsVector, } from '@pinecone-database/pinecone/dist/data/vectors/searchRecords';
/**
...
export declare class Index<T extends RecordMetadata = RecordMetadata> {
     ...
     */
    describeIndexStats(): Promise<import("@pinecone-database/pinecone/dist/data/vectors/describeIndexStats").IndexStatsDescription>;
    /**
     ...
     */
    listPaginated(options?: ListOptions): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_data").ListResponse>;
    /**
     ...
     */
    fetch(options: FetchOptions): Promise<import("@pinecone-database/pinecone/dist/data/vectors/fetch").FetchResponse<T>>;
    /**
     ...
     */
    query(options: QueryOptions): Promise<import("@pinecone-database/pinecone/dist/data/vectors/query").QueryResponse<T>>;
    /**
     ...
     */
    searchRecords(options: SearchRecordsOptions): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_data").SearchRecordsResponse>;
    /**
     ...
     */
    startImport(uri: string, errorMode?: string, integration?: string): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_data").StartImportResponse>;
    /**
     ...
     */
    listImports(limit?: number, paginationToken?: string): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_data").ListImportsResponse>;
    /**
     ...
     */
    describeImport(id: string): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_data").ImportModel>;
    /**
     ...
     * @param paginationToken - (Optional) Pagination token to continue a previous listing operation.
     */
    listNamespaces(limit?: number, paginationToken?: string): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_data").ListNamespacesResponse>;
    /**
     ...
     */
    describeNamespace(namespace: string): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_data").NamespaceDescription>;
    /**
