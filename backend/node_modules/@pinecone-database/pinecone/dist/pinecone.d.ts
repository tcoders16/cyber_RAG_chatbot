import { CollectionName, CreateBackupOptions, CreateIndexFromBackupOptions, DeleteBackupOptions, DescribeBackupOptions, ListBackupsOptions, ListRestoreJobsOptions, CreateIndexForModelOptions, CreateIndexOptions, IndexName, DescribeRestoreJobOptions } from '@pinecone-database/pinecone/dist/control';
import { CreateAssistantOptions, UpdateAssistantOptions } from '@pinecone-database/pinecone/dist/assistant/control';
import type { ConfigureIndexRequest, CreateCollectionRequest, HTTPHeaders } from '@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control';
import { Index } from '@pinecone-database/pinecone/dist/data';
import type { PineconeConfiguration, RecordMetadata } from '@pinecone-database/pinecone/dist/data';
import { Inference } from '@pinecone-database/pinecone/dist/inference';
import { Assistant } from '@pinecone-database/pinecone/dist/assistant';
/**
...
export declare class Pinecone {
     ...
     */
    describeIndex(indexName: IndexName): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").IndexModel>;
    /**
     ...
     */
    listIndexes(): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").IndexList>;
    /**
     * Creates a new index.
     *
     * @example
     ...
     */
    createIndex(options: CreateIndexOptions): Promise<void | import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").IndexModel>;
    /**
     ...
     * @returns A promise that resolves to {@link IndexModel} when the request to create the index is completed. Note that the index is not immediately ready to use. You can use the {@link describeIndex} function to check the status of the index.
     */
    createIndexForModel(options: CreateIndexForModelOptions): Promise<void | import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").IndexModel>;
    /**
     * Deletes an index
     *
     * @example
     ...
     */
    configureIndex(indexName: IndexName, options: ConfigureIndexRequest): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").IndexModel>;
    /**
     ...
     */
    createCollection(options: CreateCollectionRequest): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").CollectionModel>;
    /**
     ...
     */
    listCollections(): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").CollectionList>;
    /**
     ...
     */
    describeCollection(collectionName: CollectionName): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").CollectionModel>;
    /**
     ...
     */
    createAssistant(options: CreateAssistantOptions): Promise<import("@pinecone-database/pinecone/dist/assistant").AssistantModel>;
    /**
     ...
     * @returns A Promise that resolves to an {@link Assistant} model.
     */
    describeAssistant(assistantName: string): Promise<import("@pinecone-database/pinecone/dist/assistant").AssistantModel>;
    /**
     ...
     */
    listAssistants(): Promise<import("@pinecone-database/pinecone/dist/assistant").AssistantList>;
    /**
     ...
     */
    updateAssistant(assistantName: string, options: UpdateAssistantOptions): Promise<import("@pinecone-database/pinecone/dist/assistant").UpdateAssistantResponse>;
    /** @internal */
     ...
     */
    createBackup(options: CreateBackupOptions): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").BackupModel>;
    /**
     ...
     */
    createIndexFromBackup(options: CreateIndexFromBackupOptions): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").CreateIndexFromBackupResponse>;
    /**
     * Describes a backup.
     *
     * @example
     ...
     * @returns A Promise that resolves to a {@link BackupModel} object.
     */
    describeBackup(backupName: DescribeBackupOptions): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").BackupModel>;
    /**
     ...
     */
    describeRestoreJob(restoreJobId: DescribeRestoreJobOptions): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").RestoreJobModel>;
    /**
     * Deletes a backup.
     *
     * @example
     ...
     */
    listBackups(options: ListBackupsOptions): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").BackupList>;
    /**
     ...
     * @returns A Promise that resolves to a {@link BackupList} object.
     */
    listRestoreJobs(options: ListRestoreJobsOptions): Promise<import("@pinecone-database/pinecone/dist/pinecone-generated-ts-fetch/db_control").RestoreJobList>;
    /**
